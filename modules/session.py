...
class HttpSession:
    def __init__(self, proxy: str = None):
        ...
        self.http_client = httpx.Client(proxies=self.proxies, 
                                        headers=self.base_headers, timeout=10)
    ...
    def get_cookies(self):
        ...
        self.http_client.headers['cookie'] = f'__dcfduid={self.__dcfduid}; __sdcfduid={self.__sdcfduid}; locale=en'
